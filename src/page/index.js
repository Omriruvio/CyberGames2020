...
const teamInfo = {
  ...
  guy: {
    ...
    role: 'Co-founder',
    about:
      'co-founder of Towersec (acq. by Harman / Samsung), Ex 8200, high security positions in governmental organizations conductive security assessments of high-profile civil organizations and Ethical hacker.',
  },
  shai: {
    name: 'Shai Kavas',
    role: 'Advisory Board',
...
const rupinVideo = new URL('../videos/CyberGamesRupinCensored.mp4', import.meta.url);
